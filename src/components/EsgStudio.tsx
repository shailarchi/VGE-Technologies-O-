            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="p-4 rounded-2xl bg-[#0F172A] border border-slate-800 text-xs text-slate-400 font-mono space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px] pt-1">
                  <div>Company: <strong className="text-white">VGE Technologies OÜ</strong></div>
                  <div>Register Code: <strong className="text-[#4ADE80]">17556598</strong></div>
                  <div>LEI Identifier: <strong className="text-white">9845003828CB77B80280</strong></div>
                  <div>Jurisdiction: <strong className="text-slate-200">Estonia (EU) 🇪🇪</strong></div>
                </div>
              </div>
                ...
                <div className="space-y-4 font-mono text-xs">
                  ...
                  <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
                    <div className="flex justify-between text-slate-400">
                      ...
                      <strong className="text-white">VGE Technologies OÜ (EE17556598)</strong>
                    </div>
                    <div className="flex justify-between text-slate-400">
