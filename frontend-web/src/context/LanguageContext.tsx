...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    heroTitle: 'ESG Markets & IoT Operating System for Solar Assets',
  ...
  hi: {
    ...
    heroTitle: 'सौर परिसंपत्तियों के लिए ESG मार्केट और IoT ऑपरेटिंग सिस्टम',
  ...
  ja: {
    ...
    heroTitle: '太陽光発電資産のためのESG市場＆IoTオペレーティングシステム',
  ...
  et: {
    ...
    heroTitle: 'ESG Turgude ja IoT Operatsioonisüsteem Päikeseparkidele',
  ...
  de: {
    ...
    heroTitle: 'ESG-Märkte & IoT-Betriebssystem für Solaranlagen',
  ...
  vi: {
    ...
    heroTitle: 'Hệ điều hành IoT & Thị trường ESG cho Tài sản Năng lượng Mặt trời',
  ...
  th: {
    ...
    heroTitle: 'ระบบปฏิบัติการ IoT และตลาด ESG สำหรับสินทรัพย์โซลาร์',
  ...
  fr: {
    ...
    heroTitle: 'Marchés ESG & Système d’Exploitation IoT pour Actifs Solaires',
  ...
  es: {
    ...
    heroTitle: 'Sistema Operativo IoT y Mercados ESG para Activos Solares',
  ...
  zh: {
    ...
    heroTitle: '太阳能资产 ESG 市场与 IoT 操作系统',
